...
int RxSetServoPWM(int ch, uint16_t pwm) {
   ...
   switch (ch) {
      case 0: TIM3->CCR1 = pwm; break;
      case 1: TIM3->CCR2 = pwm; break;
      case 2: TIM3->CCR3 = pwm; break;
      case 3: TIM3->CCR4 = pwm; break;
      default: 
         return -1;
   }
...
uint16_t RxGetServoPWM(int ch) {
   ...
   switch (ch) {
      case 0: return TIM3->CCR1;
      case 1: return TIM3->CCR2;
      case 2: return TIM3->CCR3;
      case 3: return TIM3->CCR4;
      default: 
         return 0;
   }
}
